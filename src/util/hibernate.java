	    ...
	    public SessionFactory getSessionFactory() {
	        if (sessionFactory == null) {
	            try {
	                ...
	                settings.put(Environment.URL, "jdbc:mysql://localhost:3306/cantine_universitaire?useSSL=false");//nom bd
	              ...
	              // settings.put(Environment.HBM2DDL_AUTO, "create-drop");
	                ...
	                configuration.addAnnotatedClass(Boisson.class);//les classes
